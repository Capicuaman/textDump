# BILAN Random Theme Selector - n8n Function Code (No Syntax Errors)

## Corrected n8n Function Code
Copy this directly into your n8n Function node (no javascript wrapper needed):
...
2. **Delete any existing code** in the node
3. **Copy the complete code** above (choose simple or full version)
4. **Paste directly** into the Function node (no javascript wrapper)
...
The syntax error should be resolved now. Try the simple version first if you still get errors!